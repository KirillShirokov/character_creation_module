...
def attack(char_name: str, char_class: str) -> str:
    """Наносит урон противнику в зависимости от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Отражает удар противника в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет специальное умение в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит приветсвие в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — чтобы атаковать противника'
          'defence — чтобы блокировать аку противника или special'
